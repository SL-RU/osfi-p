...
if (CMAKE_C_COMPILER_ID STREQUAL "GNU")
  ...
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-Map,output.map -Wl,--gc-sections")
...
elseif (CMAKE_C_COMPILER_ID STREQUAL "Clang")
  ...
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -target arm-none-eabi -std=gnu11 -dM -fno-common -fmessage-length=0 -Wall -fno-exceptions -ffunction-sections -fdata-sections -fomit-frame-pointer -fshort-enums ${CROSS_COMPILE_GCC_C_INCLUDE_PATH}")
